...
angular.module('eiModule', []).
	controller('eiCtrl', ['$scope', '$http', '$location', '$interval', 'Restangular', function($scope, $http, $location, $interval, Restangular) {

        console.log("eiCtrl setup, v1");
